...
window.PROJECTS = [
  ...
  },
  {
    ...
    tagline: "Converts a broker's smallcase web URL into a ready-to-use in-app deep link. Supports SBI Securities (Equity, MTF) and HDFC (IR, MTF, HDFC Sky).",
    tags: ["Deep Links", "SBI", "HDFC"]
  }
];
